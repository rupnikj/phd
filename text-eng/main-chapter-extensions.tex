...
Using the technique of Lagrange multipliers (see~\ref{chu}) we can relate the stationary points of the problem in Equation~(\ref{eq:qcqp}) to solutions of a nonlinear system of equations:
