...
%In Section \ref{subsec:globalanalysis}, we will present results on global optimization that complement
%the local approach (Horst algorithm). Finally, extensions of the local approach to the non-linear and multi-dimensional case will be presented in Section~\ref{sec:sumcorextensions}.
