...
\bolded{Mono-lingual similarity.}
...
CCA can be applied to bi-lingual document analysis given two languages. 
\textcolor{red}{TODO high dimension, dual, regularization, projecting a new example}
